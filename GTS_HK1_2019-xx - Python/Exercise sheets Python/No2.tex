...
%\]
%
%b) Viết Python function dạng sau $y=Taylor(n,x0)$ trong đó $n$ là bậc của đa thức Taylor, $x0$ là điểm tại đó cần khai triển Taylor. Yêu cầu nhập vào các hệ số theo dạng vector/array $[a_0 \ a_1 ... \ a_n]$ và trả lại $y=[b_0 \ b_1 ... \ b_n]$. Test function đã viết cho hàm $f(x)$ trong câu a và $g(x)=\sin(x)$, $h(x)=\cos(x)$ tại $x0=0$.
%\end{bt}
