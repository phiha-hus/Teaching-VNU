...
de1 = e2/(B2/S2 + S2) - e1/(B1/S1 + S1)                   + epsilon*(phi/c1)* (p*q*e1*(B1/S1) - c1*e1);
de2 = e1/(B1/S1 + S1) + e3/(B3/S3 + S3) - 2*e2/(B2/S2+S2) + epsilon*(phi/c2)* (p*q*e2*(B2/S2) - c2*e2);
de3 = e2/(B2/S2 + S2) - e3/(B3/S3 + S3)                   + epsilon*(phi/c3)* (p*q*e3*(B3/S3) - c3*e3);
