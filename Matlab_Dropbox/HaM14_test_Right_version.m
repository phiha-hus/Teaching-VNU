% Right version - extract all the differential equations and algebraic constraints from 
% the double inflated system
% Plus: checking the non-advancedness of the system
