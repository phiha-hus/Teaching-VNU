...
plot "../data/ode_runge_delta0.4000.dat" u 1:2 w l ti 'runge, delta = 0.4000', \
     "../data/ode_runge_delta0.1000.dat" u 1:2 w l ti 'runge, delta = 0.1000', \
     "../data/ode_runge_delta0.0250.dat" u 1:2 w l ti 'runge, delta = 0.0250', \
     "../data/ode_runge_delta0.0063.dat" u 1:2 w l ti 'runge, delta = 0.0064', \
     "../data/ode_runge_delta0.0016.dat" u 1:2 w l ti 'runge, delta = 0.0016'  
...
plot "../data/ode_runge_delta0.4000.dat" u 1:3 w l ti 'runge, delta = 0.4000', \
     "../data/ode_runge_delta0.1000.dat" u 1:3 w l ti 'runge, delta = 0.1000', \
     "../data/ode_runge_delta0.0250.dat" u 1:3 w l ti 'runge, delta = 0.0250', \
     "../data/ode_runge_delta0.0063.dat" u 1:3 w l ti 'runge, delta = 0.0064', \
     "../data/ode_runge_delta0.0016.dat" u 1:3 w l ti 'runge, delta = 0.0016'
